...
import org.appsroid.panda.TouchGLView;
...
public class GPUImage {
    ...
    private       TouchGLView      mGlSurfaceView;
     ...
     */
    public void setGLSurfaceView(final TouchGLView view) {
        mGlSurfaceView = view;
    ...
    public Bitmap getBitmapWithFilterApplied() {
        return getBitmapWithFilterApplied(getCurrentBitmap());
    }
    ...
    public void saveToPictures(final String folderName, final String fileName,
        ...
        saveToPictures(getCurrentBitmap(), folderName, fileName, listener);
    }
