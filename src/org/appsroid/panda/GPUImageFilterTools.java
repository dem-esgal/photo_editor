...
import org.appsroid.panda.gpuimage.GPUImage3x3ConvolutionFilter;
import org.appsroid.panda.gpuimage.GPUImage3x3TextureSamplingFilter;
import org.appsroid.panda.gpuimage.GPUImageAddBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageAlphaBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageBoxBlurFilter;
import org.appsroid.panda.gpuimage.GPUImageBrightnessFilter;
import org.appsroid.panda.gpuimage.GPUImageBulgeDistortionFilter;
import org.appsroid.panda.gpuimage.GPUImageCGAColorspaceFilter;
import org.appsroid.panda.gpuimage.GPUImageChromaKeyBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageColorBalanceFilter;
import org.appsroid.panda.gpuimage.GPUImageColorBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageColorBurnBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageColorDodgeBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageColorInvertFilter;
import org.appsroid.panda.gpuimage.GPUImageContrastFilter;
import org.appsroid.panda.gpuimage.GPUImageCrosshatchFilter;
import org.appsroid.panda.gpuimage.GPUImageDarkenBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageDifferenceBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageDilationFilter;
import org.appsroid.panda.gpuimage.GPUImageDirectionalSobelEdgeDetectionFilter;
import org.appsroid.panda.gpuimage.GPUImageDissolveBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageDivideBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageEmbossFilter;
import org.appsroid.panda.gpuimage.GPUImageExclusionBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageExposureFilter;
import org.appsroid.panda.gpuimage.GPUImageFalseColorFilter;
import org.appsroid.panda.gpuimage.GPUImageFilter;
import org.appsroid.panda.gpuimage.GPUImageFilterGroup;
import org.appsroid.panda.gpuimage.GPUImageGammaFilter;
import org.appsroid.panda.gpuimage.GPUImageGaussianBlurFilter;
import org.appsroid.panda.gpuimage.GPUImageGlassSphereFilter;
import org.appsroid.panda.gpuimage.GPUImageGrayscaleFilter;
import org.appsroid.panda.gpuimage.GPUImageHardLightBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageHazeFilter;
import org.appsroid.panda.gpuimage.GPUImageHighlightShadowFilter;
import org.appsroid.panda.gpuimage.GPUImageHueBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageHueFilter;
import org.appsroid.panda.gpuimage.GPUImageKuwaharaFilter;
import org.appsroid.panda.gpuimage.GPUImageLaplacianFilter;
import org.appsroid.panda.gpuimage.GPUImageLevelsFilter;
import org.appsroid.panda.gpuimage.GPUImageLightenBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageLinearBurnBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageLuminosityBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageMonochromeFilter;
import org.appsroid.panda.gpuimage.GPUImageMultiplyBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageNonMaximumSuppressionFilter;
import org.appsroid.panda.gpuimage.GPUImageNormalBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageOpacityFilter;
import org.appsroid.panda.gpuimage.GPUImageOverlayBlendFilter;
import org.appsroid.panda.gpuimage.GPUImagePixelationFilter;
import org.appsroid.panda.gpuimage.GPUImagePosterizeFilter;
import org.appsroid.panda.gpuimage.GPUImageRGBDilationFilter;
import org.appsroid.panda.gpuimage.GPUImageRGBFilter;
import org.appsroid.panda.gpuimage.GPUImageSaturationBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageSaturationFilter;
import org.appsroid.panda.gpuimage.GPUImageScreenBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageSepiaFilter;
import org.appsroid.panda.gpuimage.GPUImageSharpenFilter;
import org.appsroid.panda.gpuimage.GPUImageSketchFilter;
import org.appsroid.panda.gpuimage.GPUImageSmoothToonFilter;
import org.appsroid.panda.gpuimage.GPUImageSobelEdgeDetection;
import org.appsroid.panda.gpuimage.GPUImageSoftLightBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageSourceOverBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageSphereRefractionFilter;
import org.appsroid.panda.gpuimage.GPUImageSubtractBlendFilter;
import org.appsroid.panda.gpuimage.GPUImageSwirlFilter;
import org.appsroid.panda.gpuimage.GPUImageToonFilter;
import org.appsroid.panda.gpuimage.GPUImageTwoInputFilter;
import org.appsroid.panda.gpuimage.GPUImageVignetteFilter;
import org.appsroid.panda.gpuimage.GPUImageWeakPixelInclusionFilter;
import org.appsroid.panda.gpuimage.GPUImageWhiteBalanceFilter;
...
public class GPUImageFilterTools {  
    ...
    public static class FilterAdjuster {
        ...
        private class SharpnessAdjuster
                extends Adjuster<GPUImageSharpenFilter> {
        ...
        private class PixelationAdjuster
                extends Adjuster<GPUImagePixelationFilter> {
        ...
        private class HueAdjuster
                extends Adjuster<GPUImageHueFilter> {
        ...
        private class ContrastAdjuster
                extends Adjuster<GPUImageContrastFilter> {
        ...
        private class GammaAdjuster
                extends Adjuster<GPUImageGammaFilter> {
        ...
        private class BrightnessAdjuster
                extends Adjuster<GPUImageBrightnessFilter> {
        ...
        private class SepiaAdjuster
                extends Adjuster<GPUImageSepiaFilter> {
        ...
        private class SobelAdjuster
                extends Adjuster<GPUImageSobelEdgeDetection> {
        ...
        private class EmbossAdjuster
                extends Adjuster<GPUImageEmbossFilter> {
        ...
        private class PosterizeAdjuster
                extends Adjuster<GPUImagePosterizeFilter> {
        ...
        private class GPU3x3TextureAdjuster
                extends Adjuster<GPUImage3x3TextureSamplingFilter> {
        ...
        private class SaturationAdjuster
                extends Adjuster<GPUImageSaturationFilter> {
        ...
        private class ExposureAdjuster
                extends Adjuster<GPUImageExposureFilter> {
        ...
        private class HighlightShadowAdjuster
                extends Adjuster<GPUImageHighlightShadowFilter> {
        ...
        private class MonochromeAdjuster
                extends Adjuster<GPUImageMonochromeFilter> {
        ...
        private class OpacityAdjuster
                extends Adjuster<GPUImageOpacityFilter> {
        ...
        private class RGBAdjuster
                extends Adjuster<GPUImageRGBFilter> {
        ...
        private class WhiteBalanceAdjuster
                extends Adjuster<GPUImageWhiteBalanceFilter> {
        ...
        private class VignetteAdjuster
                extends Adjuster<GPUImageVignetteFilter> {
        ...
        private class DissolveBlendAdjuster
                extends Adjuster<GPUImageDissolveBlendFilter> {
        ...
        private class GaussianBlurAdjuster
                extends Adjuster<GPUImageGaussianBlurFilter> {
        ...
        private class CrosshatchBlurAdjuster
                extends Adjuster<GPUImageCrosshatchFilter> {
        ...
        private class BulgeDistortionAdjuster
                extends Adjuster<GPUImageBulgeDistortionFilter> {
        ...
        private class GlassSphereAdjuster
                extends Adjuster<GPUImageGlassSphereFilter> {
        ...
        private class HazeAdjuster
                extends Adjuster<GPUImageHazeFilter> {
        ...
        private class SphereRefractionAdjuster
                extends Adjuster<GPUImageSphereRefractionFilter> {
        ...
        private class SwirlAdjuster
                extends Adjuster<GPUImageSwirlFilter> {
        ...
        private class ColorBalanceAdjuster
                extends Adjuster<GPUImageColorBalanceFilter> {
        ...
        private class LevelsMinMidAdjuster
                extends Adjuster<GPUImageLevelsFilter> {
